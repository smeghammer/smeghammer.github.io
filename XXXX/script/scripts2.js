...
function writeTopMenu(pageurl)
{
    try
    {
        ...
        for(var a=0;a<topnavarray.length;a++)
        {
            ...
            {
                output2 += "<td class=\"nav\"><img src=\"/weddingfest07/images/structure/celtic_small.gif\" alt=\"bullet\" class=\"navbullet\" /><a href=\"/"+topnavarray[a][0]+"."+suffix+"\" title=\""+topnavarray[a][1]+"\">"+topnavarray[a][1]+"</a></td>";
