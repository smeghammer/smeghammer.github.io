#!/usr/bin/perl
# EXAMPLE BINARY UPLOAD CODE:
#!/usr/bin/perl
###	NOTE: this is to demonstrate binary file upload, text file uploading is simple, 
### but if you want to know how to do textfile uploading, just remove all the binmode() 
### functions and that's it!
use CGI;
###	Set Maximum Upload size to 2MB (prevent ppl from uploading extremely large files 
### or other such malicious stuff)
$CGI::POST_MAX = 2048;


print "content-type: text/html\n\n";
###	Set Standard Input to Binary Mode (this is critical for binary data (e.g. 
### images) - the key piece of this code which nobody tells you (except me))
binmode(STDIN);
@inx = <STDIN>;
