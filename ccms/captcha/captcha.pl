...
# configuration
$tempdir = "$document_root/ccms/captcha/temp";
$imagedir = "$document_root/ccms/captcha/images";

##########################
# open image dir choose a random image
logger("IMAGE DIR: $imagedir");
...
logger("image number: $randomnumber");
logger("image: $randomimage");
