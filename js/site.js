        ...
        {'linktext':'Home','url':'/', 'parenturl':null, 'pagekey':'0', 'childs':[
           {'linktext':'My WADs','url':'/maps/', 'parenturl':'/', 'pagekey':'0.0', 'childs':[
            ...
            {'linktext':'Snippets','url':'/snippets/', 'parenturl':'/', 'pagekey':'0.1', 'childs':[
                ...
                {'linktext':'ACS tests',"repopath":"ACS_TESTS",	"img":"1",		'url':'/snippets/acs_tests.htm', 'parenturl':'/snippets/', 'pagekey':'0.1.3', 'childs':[],visible:true,"summary":"An early ACS test that triggers sequential platform lowering."},
                ...
                {'linktext':'Custom sound',"repopath":"custom_sound_test",	"img":"1",		'url':'/snippets/custom_sound_test.htm', 'parenturl':'/snippets/', 'pagekey':'0.1.5', 'childs':[],visible:true,"summary":"First test of SNDINFO and adding a custom sound. "},
                ...
                {'linktext':'Footsteps',"repopath":"footsteps",	"img":"1",			'url':'/snippets/footsteps.htm', 'parenturl':'/snippets/', 'pagekey':'0.1.8', 'childs':[],visible:true,"summary":"Tryng to simulate footsteps on different surfaces."},
                {'linktext':'Increment test',"repopath":"increment-test",	"img":"1",		'url':'/snippets/increment-test.htm', 'parenturl':'/snippets/', 'pagekey':'0.1.9', 'childs':[],visible:true,"summary":"More ACS tests, adding a count logic."},
                ...
                {'linktext':'Remote kill',  "repopath":"remote_kill_test", "img":"1",	       'url':'/snippets/rekill.htm', 'parenturl':'/snippets/', 'pagekey':'0.1.16', 'childs':[],visible:true,"summary":"An experiment with killing monsters on another map. Uses some ACS logic and global variables."},
