...
#print "Content-type: text/html\r\n\r\n";
  ...
  my $reply_to    = "Reply-to: enquiry\@clement-jewitt.co.uk\n"; #the hosting domain!
  my $subject     = "Subject: Website enquiry\n"; 
  my $content     = ""; 
  my $to          = "silas\@thecoven.co.uk,1219cj\@phonecoop.coop\n";
  ...
  print SENDMAIL "From: autoreply\@clement-jewitt.co.uk\n";
